addEventHandler("onClientHUDRender", root, function()
    ...
    ov_widget.progress.draw({
        id = "progress#2-1",
        type = "vertical",
        x = 100 + 275 + 25 + 25 + 25, y = 100 + 24 + 25 + 32 + 25 + 133,
        width = 8, height = 142, 
        progress = 0.25,
        font_family = "default-bold",
        background_color = {31, 31, 31},
    ...
    ov_widget.progress.draw({
        id = "progress#2-2",
        type = "vertical",
        x = 100 + 275 + 25 + 25 + 25 + 8 + 25, y = 100 + 24 + 25 + 32 + 25 + 133,
        width = 8, height = 142, 
        progress = 0.75,
        font_family = "default-bold",
        background_color = {31, 31, 31},
    ...
    ov_widget.progress.draw({
        id = "progress#2-3",
        type = "vertical",
        x = 100 + 275 + 25 + 25 + 25 + 8 + 25 + 8 + 25, y = 100 + 24 + 25 + 32 + 25 + 133,
        width = 8, height = 142, 
        progress = 0.5,
        font_family = "default-bold",
        background_color = {31, 31, 31},
    ...
    ov_widget.progress.draw({
        id = "progress#2-4",
        type = "vertical",
        x = 100 + 275 + 25 + 25 + 25 + 8 + 25 + 8 + 25 + 8 + 25, y = 100 + 24 + 25 + 32 + 25 + 133,
        width = 8, height = 142, 
        progress = 0.35,
        font_family = "default-bold",
        background_color = {31, 31, 31},
    ...
    ov_widget.progress.draw({
        id = "progress#2-5",
        type = "vertical",
        x = 100 + 275 + 25 + 25 + 25 + 8 + 25 + 8 + 25 + 8 + 25 + 8 + 25, y = 100 + 24 + 25 + 32 + 25 + 133,
        width = 8, height = 142, 
        progress = 0.6,
        font_family = "default-bold",
        background_color = {31, 31, 31},
